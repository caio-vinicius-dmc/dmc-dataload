...
class RotinasController
{
    ...
    public function listar(): array
    {
        ...
        $s = $db->query("SELECT r.id, r.nome, r.descricao, r.esta_executando, p.nome_conexao FROM tb_rotinas r JOIN tb_perfis_conexao p ON r.id_conexao = p.id ORDER BY r.id DESC");
